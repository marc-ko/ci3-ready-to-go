            ...
            <div class="col-lg-4 col-sm-6">
               ...
               <div class="footer_menu">
                  <ul>
                     ...
                     <li><a href="about.html"><span class="angle_icon"><i class="fa fa-arrow-right"
            ...
            <div class="col-lg-4 col-sm-6">
               ...
               <div class="location_text">
                  <ul>
                     <li>
                        <a href="#">
                           <span class="padding_left_10"><i class="fa fa-map-marker" aria-hidden="true"></i></span>It is
                           a long established fact that a<br> reader will be distracted</a>
                     </li>
                     <li>
                        <a href="#">
                           <span class="padding_left_10"><i class="fa fa-phone" aria-hidden="true"></i></span>(+71)
                           1234567890<br>(+71) 1234567890
                        </a>
                     </li>
                     <li>
                        <a href="#">
